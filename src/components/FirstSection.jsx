...
const FirstSection = () => {
  return (
    <div className='h-[85vh] w-full flex items-center'>
      {/* left  */}
      <div className="left h-full lg:w-[50%] lg:h-[100%] flex flex-col justify-center items-center">
        <div className='text-white'>
          ...
          <h1 className='primaryColor text-8xl m-0 font-bold my-1'>Satyajeet</h1>
          <p className='capitalize text-2xl tracking-wider'>Grapics Designer and video editor</p>
        </div>
        {/* underline div  */}
      ...
      <div className="right h-full lg:w-[50%] lg:h-[100%] flex flex-col justify-center items-end">
       <div className='wrapperOfLensBlur relative'>
        ...
        <div className="lensBlur lensBlue2 h-[140px] w-[140px] bg-amber-600 blur-3xl z-0 absolute right-[140px]">
        </div>
